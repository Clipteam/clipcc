 ...
 */
export class FlyoutExtensionCategoryHeader extends FlyoutButton {
  /**
   ...
   */
  constructor(workspace, targetWorkspace, xml) {
    super(workspace, targetWorkspace, xml, false, true);
   ...
   * @public
   */
  static getExtensionState() /* extensionId */{
