...
export class ContextMenu {
   ...
   */
  static callbackFactory(block, xml) {
    return function() {
      eventUtils.disable();
      let newBlock;
      try {
   ...
   * @package
   */
  static blockDeleteOption(block) {
   ...
   * @package
   */
  static blockDuplicateOption(block, event) {
   ...
   * @package
   */
  static blockCommentOption(block) {
    const commentOption = {
   ...
   * @package
   */
  static wsCleanupOption(ws, numTopBlocks) {
    return {
      text: Msg.CLEAN_UP,
   ...
   * @private
   */
  static toggleCollapseFn_(topBlocks, shouldCollapse) {
   ...
   * @package
   */
  static wsCollapseOption(hasExpandedBlocks, topBlocks) {
    return {
   ...
   * @package
   */
  static wsExpandOption(hasCollapsedBlocks, topBlocks) {
    return {
   ...
   * @package
   */
  static commentDeleteOption(comment) {
    const deleteOption = {
      text: Msg.DELETE,
      enabled: true,
      callback: function() {
   ...
   * @package
   */
  static commentDuplicateOption(comment) {
    const duplicateOption = {
      text: Msg.DUPLICATE,
      enabled: true,
      callback: function() {
   ...
   * @package
   */
  static workspaceCommentOption(ws, e) {
