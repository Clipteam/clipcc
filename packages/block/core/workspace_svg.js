...
export class WorkspaceSvg extends Workspace {
   ...
   * @private
   */
  static buildDeleteList_(topBlocks) {
    let deleteList = [];
   ...
   * @private
   */
  static getContentDimensions_(ws, svgSize) {
    if (ws.scrollbar) {
   ...
   * @private
   */
  static getContentDimensionsExact_(ws) {
   ...
   * @private
   */
  static getContentDimensionsBounded_(ws, svgSize) {
   ...
   * @this WorkspaceSvg
   */
  static getTopLevelWorkspaceMetrics_() {
   ...
   */
  setToolboxRefreshEnabled(enabled) {
   ...
   * @package
   */
  startDragWithFakeEvent(fakeEvent, block) {
   ...
   * @param {boolean=} opt_allowToolbox If true, don't close the toolbox.
   */
  hideChaffOnResize(opt_allowToolbox) {
    this.hideChaffInternal_(opt_allowToolbox);
   ...
   * @private
   */
  hideChaffInternal_(opt_allowToolbox) {
    Tooltip.hide();
    DropDownDiv.hideWithoutAnimation();
    if (!opt_allowToolbox) {
      if (this.toolbox_ &&
