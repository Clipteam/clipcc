...
export class FieldDropdown extends Field {
   ...
   * @param {boolean=} opt_skipConstruct Whether skip dropdown's constructor
   */
  constructor(menuGenerator, opt_validator, opt_skipConstruct) {
    // Call parent's constructor, but not set value since this is not avaiable
