...
export class Block {
   ...
   */
  getDescendants(ordered, opt_ignoreShadows) {
    const blocks = [this];
  ...
  */
   ...
   * @private
   */
  setColourFromRawValues_(primary, secondary, tertiary, quaternary) {
   ...
   * @private
   */
  interpolate_(message, args, lastDummyAlign) {
   ...
   */
  setCheckboxInFlyout(hasCheckbox) {
