...
export class DropDownDiv {
   ...
   */
  static setBoundsElement(boundsElement) {
   ...
   */
  static setColour(backgroundColour, borderColour) {
   ...
   */
  static showPositionedByBlock(owner, block, opt_onHide, opt_secondaryYOffset) {
   ...
   */
  static show(owner, primaryX, primaryY, secondaryX, secondaryY, opt_onHide) {
   ...
   */
  static getPositionMetrics(primaryX, primaryY, secondaryX, secondaryY) {
    const div = DropDownDiv.DIV_;
