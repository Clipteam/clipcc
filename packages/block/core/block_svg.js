...
export class BlockSvg extends Block {
  ...
  constructor(workspace, prototypeName, opt_id) {
     ...
     * @type {number}
     */
    this.insertionMarkerMinWidth_ = 0;
   ...
   */
  setInsertionMarker(insertionMarker, opt_minWidth) {
    super.setInsertionMarker(insertionMarker);
   ...
   */
  setCommentText(text, commentId, commentX, commentY, minimized) {
   ...
   * @package
   */
  setMouseThroughStyle(letMouseThrough) {
    if (letMouseThrough) {
   ...
   *    string.
   */
  setColour(colour, colourSecondary, colourTertiary, colourQuaternary) {
    super.setColour(colour, colourSecondary,
  ...
  setPreviousStatement(newBoolean, opt_check) {
    super.setPreviousStatement(newBoolean,
        opt_check);
  ...
  setNextStatement(newBoolean, opt_check) {
    super.setNextStatement(newBoolean,
        opt_check);
  ...
  removeInput(name, opt_quiet) {
    super.removeInput(name, opt_quiet);
  ...
  moveNumberedInputBefore(inputIndex, refIndex) {
    super.moveNumberedInputBefore(inputIndex,
        refIndex);
