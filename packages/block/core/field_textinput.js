...
export class FieldTextInput extends Field {
   ...
   * @private
   */
  bindEvents_(htmlInput, bindGlobalKeypress) {
  ...
  */
   ...
   * @private
   */
  widgetDisposeAnimationFinished_() {
    return function() {
   ...
   */
  static nonnegativeIntegerValidator(text) {
