 ...
 * @constructor
 */
export const FieldIconMenu = function(icons) {
  /** @type {object} */
  this.icons_ = icons;
  // Example:
  ...
  FieldIconMenu.superClass_.constructor.call(this, defaultValue);
  this.addArgType('iconmenu');
};
goog.inherits(FieldIconMenu, Field);
 ...
 * @nocollapse
 */
FieldIconMenu.fromJson = function(element) {
 ...
 */
FieldIconMenu.prototype.init = function(block) {
  if (this.fieldGroup_) {
  ...
  FieldIconMenu.superClass_.init.call(this, block);
};
 ...
 * @override
 */
FieldIconMenu.prototype.setValue = function(newValue) {
 ...
 * @private
 */
FieldIconMenu.prototype.setParentFieldImage = function(src) {
 ...
 */
FieldIconMenu.prototype.getValue = function() {
  return this.value_;
};
 ...
 */
FieldIconMenu.prototype.getSrcForValue = function(value) {
 ...
 * @private
 */
FieldIconMenu.prototype.showEditor_ = function() {
 ...
 * @private
 */
FieldIconMenu.prototype.buttonClick_ = function(e) {
 ...
 */
FieldIconMenu.prototype.onHide_ = function() {
