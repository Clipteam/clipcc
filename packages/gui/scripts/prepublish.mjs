...
const downloadMicrobitHex = async () => {
    const url = process.env.NO_CDN ? 'https://static.codingclip.com/scratch-microbit-1.2.0.hex.zip' : 'https://downloads.scratch.mit.edu/microbit/scratch-microbit-1.2.0.hex.zip';
