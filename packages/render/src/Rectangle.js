/**
 * The Rectangle class represents an axis-aligned rectangle in Scratch 2D coordinate space.
 * It provides utilities for initializing, comparing, and manipulating rectangles.
 * @class
 */
class Rectangle {
    /**
