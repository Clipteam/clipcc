...
/**
 * A renderer for drawing Scratch sprites to a canvas using WebGL.
 */
class RenderWebGL extends EventEmitter {
    ...
    /**
     * Get the "native" size of the stage, which is used for pen, query renders, etc.
    ...
    /**
     * Determine the maximum number of pixels to process on the CPU
     * before switching to the GPU path for isTouchingColor.
     * @private
     * @returns {number} The maximum number of pixels to process on the CPU.
     */
    _getMaxPixelsForCPU () {
    ...
    /**
     * Finish GPU touching color test.
     * @private
     * @param bounds
     * @param color3b
     * @param stop
    ...
    /**
     * Request a snapshot of the current stage drawing.
