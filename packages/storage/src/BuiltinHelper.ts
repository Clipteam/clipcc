...
import {AssetType, type AssetTypeValue} from './AssetType';
...
export default class BuiltinHelper extends Helper {
     ...
     * @returns {string} The calculated id of the cached asset, or the supplied id if the asset is mutable.
     */
    store (assetType: AssetTypeValue, dataFormat: IDataFormat, data: AssetData, id: AssetId): AssetId {
     ...
     * @returns {string} The calculated id of the cached asset, or the supplied id if the asset is mutable.
     */
    _store (assetType: AssetTypeValue, dataFormat: IDataFormat, data: AssetData, id?: AssetId | null): AssetId {
        let assetId = id;
     ...
     */
    load (assetType: AssetTypeValue, assetId: AssetId): Promise<Asset | null> | null {
        if (!this.get(assetId)) {
