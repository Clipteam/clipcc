 ...
 * @typedef {object} IAssetType - Information about a supported asset type.
 ...
 * @property {IDataFormat} runtimeFormat - The default format used for runtime, in-memory storage of this asset. For
