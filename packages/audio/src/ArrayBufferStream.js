/**
  The ArrayBufferStream class wraps an ArrayBuffer to provide stream-like
  access to its data, allowing for sequential reading of various data types.
 */
class ArrayBufferStream {
    ...
    /**
     * Get the number of bytes available to read from the current position
