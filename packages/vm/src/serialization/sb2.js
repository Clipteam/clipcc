 ...
 * @returns {Array.<object>} Flattened list to be passed to `blocks.createBlock`.
 */
 ...
 * @returns {!Promise.<Array.<Target>>} Promise for the loaded targets when ready, or null for unsupported objects.
 */
 ...
 * @returns {object} specmap block to parse this opcode
 */
