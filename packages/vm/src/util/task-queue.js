...
class TaskQueue {
    ...
    constructor (maxTokens, refillRate, options = {}) {
        ...
        this._tokenCount = Object.prototype.hasOwnProperty.call(options, 'startingTokens') ? options.startingTokens : maxTokens;
        this._maxTotalCost = Object.prototype.hasOwnProperty.call(options, 'maxTotalCost') ? options.maxTotalCost : Infinity;
