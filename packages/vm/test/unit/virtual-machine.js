...
test('emitWorkspaceUpdate', t => {
    ...
    t.not(jsonStr.indexOf('global'), -1);
    t.not(jsonStr.indexOf('local'), -1);
    t.equal(jsonStr.indexOf('unused'), -1);
    t.not(jsonStr.indexOf('blocks'), -1);
    t.equal(jsonStr.indexOf('aStageComment'), -1);
    t.equal(jsonStr.indexOf('someBlockComment'), -1);
    t.not(jsonStr.indexOf('someOtherComment'), -1);
    t.not(jsonStr.indexOf('aBlockComment'), -1);
    t.end();
});
