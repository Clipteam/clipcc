...
class ColorPicker extends React.Component {
    ...
    handleHueChange (hue) {
        ...
        this.setState({hue: hue, hex: newHex}, () => {
    ...
    handleSaturationChange (saturation) {
        ...
        this.setState({saturation: saturation, hex: newHex}, () => {
            this.handleColorChange();
        });
    }
    handleBrightnessChange (brightness) {
        ...
        this.setState({brightness: brightness, hex: newHex}, () => {
            this.handleColorChange();
        });
    }
    handleHexChange (hex) {
        if (hex !== this.state.hex) {
            const newHsv = this.getHsv(hex);
            this.setState({
                hue: newHsv[0],
                saturation: newHsv[1],
                brightness: newHsv[2],
